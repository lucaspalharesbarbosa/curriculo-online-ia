...
Fase 6 (divulgação) ainda não iniciada formalmente — checklist em `docs/product/roadmap.md` (Fase 6), sem histórias de backlog. Fase 7 (Frontend & UX v2) com as 4 histórias do `PRD-005` decompostas em `docs/product/backlog/fase-07/`, todas com DoR fechado e `Ready for Agent`: [US-07-01](../product/backlog/fase-07/US-07-01-contato-whatsapp.md) e [US-07-02](../product/backlog/fase-07/US-07-02-auditoria-responsividade.md) (P1); [US-07-03](../product/backlog/fase-07/US-07-03-redesign-visual.md) (P2, redesign visual — referência visual definida em 2026-08-06: template Omnira/Framer, `https://omnira.framer.website/`, print do autor); [US-07-04](../product/backlog/fase-07/US-07-04-revisao-nextjs.md) (P3). Lembrete de dependência: US-07-03 depende de US-07-02 (auditoria de responsividade) estar Done antes de redesenhar, para não corrigir responsividade em cima de layout que ainda vai mudar. Fases 8 a 12 (segurança/performance, qualidade de engenharia, observabilidade, chat v2, área administrativa) seguem em `draft` — PRDs criados (`PRD-006` a `PRD-010`), histórias ainda não decompostas.
