...
| Fase 9 — Qualidade de Engenharia | SonarCloud, gate de cobertura no CI, boas práticas REST, refactor guiado por achados | `docs/product/backlog/fase-09/` — US-09-01 Done; demais itens do `PRD-007` sem história ainda |
