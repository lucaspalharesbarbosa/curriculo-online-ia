...
| Fase 8 — Segurança & Performance | Auditoria de segurança e performance, cold start do Render free tier, timeout OpenAI | `docs/product/backlog/fase-08/` (US-08-01 a US-08-11) — 11/11 Done, candidata a arquivamento |
