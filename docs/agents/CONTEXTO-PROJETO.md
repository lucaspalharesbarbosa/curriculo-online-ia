...
| Fase 14 — Arquitetura & Modularização | Reorganização de backend/frontend por domínio (`resume`/`chat`, preparado para `admin`), DDD-lite | `docs/product/backlog/fase-14/` (US-14-01 a US-14-02) — 0/2, Ready for Agent |
