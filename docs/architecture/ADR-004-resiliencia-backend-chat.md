...
- `backend/app/rag.py` (`get_client()`) configura timeout explícito (`20s`) e `max_retries=1` — implementado em [US-08-02](../product/backlog/archive/fase-08/US-08-02-timeout-retry-openai.md)
