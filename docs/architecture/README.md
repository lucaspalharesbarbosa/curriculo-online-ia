...
## Próximo ADR previsto
Fluxo de RAG (chunking, embeddings, custo) — [US-05-01](../product/backlog/fase-05/US-05-01-adr-fluxo-rag.md) em [PRD-003-rag.md](../product/PRD-003-rag.md), a ser conduzido quando a Fase 5 do plano entrar em execução.
